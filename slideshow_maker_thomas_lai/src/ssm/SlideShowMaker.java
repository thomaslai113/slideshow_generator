package ssm;
//Thomas Lai CSE 219  HW2 109872221
...
public class SlideShowMaker extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ui.recieveLanguage();
        boolean success = loadProperties(ui.getLanguage());
        if (success) {
	    ...
	    errorHandler.processError(LanguagePropertyType.ERROR_DATA_FILE_LOADING, "Could not Load Properties,load files or Start UI", "Unknown Error, Check Files");
	    System.exit(0);
	}
    }
     ...
     */
    public boolean loadProperties(boolean lang) {
        try {
            ...
            if(lang == true)
                ...
                props.loadProperties(UI_PROPERTIES_FILE_NAME_SP, PROPERTIES_SCHEMA_FILE_NAME);
            return true;
       } catch (InvalidXMLFileFormatException ixmlffe) {
            // SOMETHING WENT WRONG INITIALIZING THE XML FILE
            ErrorHandler eH = ui.getErrorHandler();
            eH.processError(LanguagePropertyType.ERROR_PROPERTIES_FILE_LOADING,"Could not Load Properties", ixmlffe.getMessage());
            return false;
        }        
    }
